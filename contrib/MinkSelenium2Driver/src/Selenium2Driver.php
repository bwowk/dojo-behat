...
JS;
    ...
    public function setValue($xpath, $value)
    {
        ...
        if ('input' === $elementName) {
            ...
            if (in_array($elementType, array('submit', 'image', 'button', 'reset'))) {
                throw new DriverException(sprintf('Impossible to set value an element with XPath "%s" as it is not'
                    . ' a select, textarea or textbox', $xpath));
            }
    ...
    public function selectOption($xpath, $value, $multiple = false)
    {
        ...
        throw new DriverException(sprintf('Impossible to select an option on the element with XPath "%s" as it is not'
            . ' a select or radio input', $xpath));
    }
